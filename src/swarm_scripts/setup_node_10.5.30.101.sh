...
tmux new-session -d -s ebpf_sniffer "sudo python3 new-architecture-USC.py -p $PIDS --log-handler http://10.105.18.100:5000/ingest 2>&1 | tee sniffer_10.5.30.101.log"
