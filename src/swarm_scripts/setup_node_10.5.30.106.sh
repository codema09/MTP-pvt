...
cd ..
sudo nohup python3 new-architecture-USC.py -p $PIDS > "sniffer_10.5.30.106.log" 2>&1 &

echo "==========================================================="
echo "✅ Setup Complete!"
echo "Docker services are UP."
echo "Sniffer is detached and logging to: src/sniffer_10.5.30.106.log"
echo "Check \`tail -f src/sniffer_10.5.30.106.log\` for live memory profiling."
echo "==========================================================="
